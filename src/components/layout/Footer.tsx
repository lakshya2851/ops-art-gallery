...
import { Instagram, MapPin, Phone, Star, ArrowUpRight } from "lucide-react";
    ...
    <footer className="bg-[#0A0908] border-t border-white/10 pt-20 pb-12 text-gallery-white">
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pb-16 border-b border-white/10">
          ...
          {/* Column 2: Hours & Visit Info (4 cols) */}
          <div className="md:col-span-4 space-y-4">
            ...
            <p className="text-[11px] text-gallery-brass/80 pt-1">
              * Note: Operating hours flagged as {GALLERY_INFO.hoursNotice}
            </p>
          </div>
