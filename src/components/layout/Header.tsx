    ...
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          <Link
            href="/admin"
            className="text-xs uppercase tracking-[0.2em] px-4 py-2 border border-white/10 text-gallery-muted hover:text-gallery-brass hover:border-gallery-brass/40 transition-all flex items-center space-x-2"
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 top-[70px] bg-[#0E0D0C]/98 backdrop-blur-xl z-50 flex flex-col justify-between px-8 py-12 border-t border-white/10">
          <div className="flex flex-col space-y-8">
            ...
            <Link
              href="/admin"
              className="font-serif text-2xl text-gallery-brass flex items-center space-x-2"
            >
              <Shield size={20} />
