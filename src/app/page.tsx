...
export default function HomePage() {
  ...
  const instagramPhotos = [
    { src: ARTWORKS[0].imageSrc, alt: "OPS Art Gallery Exhibition Room" },
    { src: ARTWORKS[1].imageSrc, alt: "Sculpture Installation at Shahpur Jat" },
    { src: ARTWORKS[2].imageSrc, alt: "Artist Canvas Detail" },
    { src: ARTWORKS[3].imageSrc, alt: "Contemporary Painting Exhibition" },
  ];
